<?php
	...
	if (isset($_POST['add'])) {
		...
		mysqli_query($con, "INSERT INTO t_wwtp  (id_wwtp, id_wwtp_tr, id_ph_tr, id_header, tanggal, bulan, max_release, status_ph)
		 VALUES ('$id_wwtp', '$id_wwtp_tr', '$id_ph_tr', '$id_header', '$tanggal', '$bulan', '$max_release', '$status_ph')") or die(mysqli_error($con));
