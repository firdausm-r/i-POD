<?php
	...
	if (isset($_POST['add'])) {
		...
		mysqli_query($con, "INSERT INTO t_masyarakat24  (id_motor, id_header, tanggal, bulan, meter_awal, meter_akhir, pemakaian, pemantauan)
		 VALUES ('$id_motor', '$id_header', '$tanggal', '$bulan', '$meter_awal', '$meter_akhir', '$pemakaian', '$pemantauan')") or die(mysqli_error($con));

		echo "<script>alert('Data Meteran Masyarakat-24 berhasil tersimpan');window.location='create_detail.php';</script>";
	}
