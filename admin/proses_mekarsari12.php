<?php
	...
	if (isset($_POST['add'])) {
		...
		mysqli_query($con, "INSERT INTO t_mekarsari12  (id_motor, id_header, tanggal, bulan, meter_awal, meter_akhir, pemakaian, pemantauan)
		 VALUES ('$id_motor', '$id_header', '$tanggal', '$bulan', '$meter_awal', '$meter_akhir', '$pemakaian', '$pemantauan')") or die(mysqli_error($con));

		echo "<script>alert('Data Meteran Mekarsari M-12 berhasil tersimpan');window.location='create_detail.php';</script>";
	}
