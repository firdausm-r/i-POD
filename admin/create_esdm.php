        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">ESDM | <i class="fas fa-plus-circle"></i> Add New</h3>
                </div>
                <form class="form-horizontal" action="create_esdm_proses.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="kepada" class="col-sm-4 col-form-label"> KEPADA</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="kepada" id="kepada" required>
                        <input type="text" class="form-control" name="id_esdm" id="id_esdm" hidden>
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="nama_upt" class="col-sm-4 col-form-label">NAMA UPT</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_upt" id="nama_upt" required>
                      </div>
                    </div>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">General Data Reg ESDM</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
                          ...
                          <table class="table table-striped" id="example3">
                            ...
                            <tbody>
                              <?php
                                ...
                                $query = "SELECT * FROM M_esdm ORDER BY id_esdm DESC ";
