<?php
	...
	if (isset($_POST['add'])) {
		...
		mysqli_query($con, "INSERT INTO t_overflow14  (id_motor, id_header, tanggal, bulan, meter_awal, meter_akhir, pemakaian, pemantauan)
		 VALUES ('$id_motor', '$id_header', '$tanggal', '$bulan', '$meter_awal', '$meter_akhir', '$pemakaian', '$pemantauan')") or die(mysqli_error($con));

		mysqli_query($con, "INSERT INTO t_sungai2  (id_sungai, id_header, tanggal, bulan, meter_awal, meter_akhir, pemakaian, pemantauan)
		 VALUES ('$id_motor', '$id_header', '$tanggal', '$bulan', '$meter_awal', '$meter_akhir', '$pemakaian', '$pemantauan')") or die(mysqli_error($con));

		echo "<script>alert('Data Meteran Overflow M-14 berhasil tersimpan');window.location='create_detail.php';</script>";
	}
