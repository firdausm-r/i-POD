        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Create SIPA | <i class="fas fa-plus-circle"></i> Add New</h3>
                </div>
                <form class="form-horizontal" action="create_sipa_proses.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="no_sipa" class="col-sm-4 col-form-label"> No. SIPA</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="no_sipa" id="no_sipa" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="alamat_perusahaan" class="col-sm-4 col-form-label">NAMA PERUSAHAAN</label>
                      <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                      <label for="lokasi_pengambilan" class="col-sm-4 col-form-label">LOKASI PENGAMBILAN</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="lokasi_pengambilan" id="lokasi_pengambilan" required>
                      </div>
                    </div>


                    <div class="form-group row">
                      <label for="tanggal_sipa" class="col-sm-4 col-form-label">TANGGAL SIPA</label>
                      <div class="col-sm-8">
                        <input type="date" class="form-control" name="tanggal_sipa" id="tanggal_sipa" required>
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="titik_sumur" class="col-sm-4 col-form-label">TITIK SUMUR</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="titik_sumur" id="titik_sumur" required>
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="koordinat_b" class="col-sm-4 col-form-label">KOORDINAT B</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="koordinat_b" id="koordinat_b" required>
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="koordinat_l" class="col-sm-4 col-form-label">KOORDINAT L</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="koordinat_l" id="koordinat_l" required>
                      </div>
                    </div>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">General Data SIPA Plant</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
                          ...
                          <table class="table table-striped" id="example3">
                            ...
                            <tbody>
                              <?php
                                ...
                                $query = "SELECT * FROM M_sipa ORDER BY no_sipa DESC ";
                              ...
                              <tr>
                                <td><?php echo $no++;?></td>
                                <td><?php echo $data['no_sipa'];?></td>
                                <td><?php echo $data['sumber'];?></td>
                                <td><?php echo $data['tanggal_sipa'];?></td>
