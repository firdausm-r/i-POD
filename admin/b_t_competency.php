...
<body class="hold-transition sidebar-mini sidebar-collapse">
                            ...
                            <table class="table table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><input type="text" name="title_competency" id="title_competency" class="form-control" value="<?php echo $data2['title_competency'] ?>" readonly> </td>
                              ...
                              <tbody> 
                                <tr>
                                  <td>
                                    ...
                                    <input type="text" name="id_competency[]" id="id_competency" class="form-control" value="<?php echo $r2['id_competency'] ?>" hidden>
                                  </td>
                                  <td>
                                    <select name="type_competency[]" class="form-control" required>
                                  ...
                                  <td>
                                    <select name="category_competency[]" class="form-control" required>
                                      <option value="">-- Select --</option>
  ...
  <script>  
    $(document).ready(function(){  
     ...
     $('#add').click(function(){  
        i++;  
        $('#dynamic_field').append('<tr id="row'+i+'"><td><input name="list_competency[]" class="form-control" required> <input type="text" name="id_competency[]" id="id_competency" class="form-control" value="<?php echo $r2['id_competency'] ?>" hidden></td><td><select name="type_competency[]" class="form-control" required><option value="">-- Select --</option><option value="KNOWLEDGE">KNOWLEDGE</option><option value="SKIL">SKIL</option><option value="ATTITUDE">ATTITUDE</option></select></td><td><select name="category_competency[]" class="form-control" required><option value="">-- Select --</option><option value="SAFETY">SAFETY</option><option value="QUALITY">QUALITY</option><option value="OPERATIONAL">OPERATIONAL</option><option value="MAINTENANCE">MAINTENANCE</option><option value="TROUBLE SHOOT">TROUBLE SHOOT</option><option value="DAMAWAY"></option></select></td> <td><select name="status_list[]" class="form-control"><option value="AKTIF">AKTIF</option><option value="INAKTIF">INAKTIF</option></select></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove"><i class="fas fa-trash"></i> Delete</button></td></tr>');  
     });  
